...
import { faAddressCard, faBars, faBasketShopping, faCartShopping, faHeartPulse, faHouse, faPhone, faPowerOff, faRectangleList, faRightToBracket, faUserGear, faUserPlus } from '@fortawesome/free-solid-svg-icons'
